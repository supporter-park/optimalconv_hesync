...
func testResNet_crop_sparse(st, end, ker_wid, depth int, debug, cf100 bool, externalCont *context) {
...
func testResNet_crop_sparse_wide(st, end, ker_wid, depth, wide_case int, debug, cf100 bool, externalCont *context) {
	// init_batch fixed to 16
	ker_name := "ker" + strconv.Itoa(ker_wid)
