...
type Evaluator interface {
	...
	RotateGal(ct0 *Ciphertext, galEl uint64, ctOut *Ciphertext)
...
// Added by DWKim
// RotateGal rotates the ciphertext poly by galEl
// If the provided element is a Ciphertext, a key-switching operation is necessary and a rotation key for the specific rotation needs to be provided.
func (eval *evaluator) RotateGal(ct0 *Ciphertext, galEl uint64, ctOut *Ciphertext) {
